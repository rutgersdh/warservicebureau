...
<figure>
  ...
  <figcaption style="color:gray; font-size:0.8em; text-align: left;">Varsity Football Team photo of 1917, with Paul Robeson in frame</figcaption>
</figure>
...
<button class="btn" role="btn" onclick="filterLetters('censorship')">Censorship</button>
<button class="btn" role="btn" onclick="filterLetters('collectibles')">Collectibles</button>
<button class="btn" role="btn" onclick="filterLetters('correspondence')">Military correspondence</button>
<button class="btn" role="btn" onclick="filterLetters('diseases')">Diseases</button>
<button class="btn" role="btn" onclick="filterLetters('families')">Families</button>
<button class="btn" role="btn" onclick="filterLetters('flu')">Influenza Pandemic</button>
<button class="btn" role="btn" onclick="filterLetters('football')">Football</button>
<button class="btn" role="btn" onclick="filterLetters('greek-life')">Greek letter societies</button>
<button class="btn" role="btn" onclick="filterLetters('loneliness')">Loneliness</button>
<button class="btn" role="btn" onclick="filterLetters('marriage')">Marriage</button>
<button class="btn" role="btn" onclick="filterLetters('masculinity')">Masculinity</button>
<button class="btn" role="btn" onclick="filterLetters('military-hospitals')">Military hospitals</button>
<button class="btn" role="btn" onclick="filterLetters('military-operations')">Military operations</button>
<button class="btn" role="btn" onclick="filterLetters('money')">Money</button>
<button class="btn" role="btn" onclick="filterLetters('officers')">Officers</button>
<button class="btn" role="btn" onclick="filterLetters('ptsd')">PTSD</button>
<button class="btn" role="btn" onclick="filterLetters('routine')">Routine</button>
<button class="btn" role="btn" onclick="filterLetters('transatlantic-travel')">Transatlantic voyages</button>
<button class="btn" role="btn" onclick="filterLetters('u-boats')">U-boats</button></div>

## Elmer G. Bracher to Earl Reed Silvers, July 29, 1917

<section class="letter" data-tags="all transatlantic-travel correspondence">
...
<section class="letter" data-tags="all transatlantic-travel"><p class="small"><i>[An illustration of Belgian soldiers fighting in the war during the winter, by Alfred Bastien. Two of them are aiming down their sights over a barricade while a third one patrols. Another three soldiers are tending to a wounded soldier lying on the ground.]</i><br /></p>
<span class="pre-printed">CARTE POSTALE.</span><p class="pre-printed centered"><br>NEW YORK, N.Y. 2<br>AUG 7<br>10 AM<br>1917</p><span class="pre-printed">Côté reservé à l'adresse.</span> Au revoir. <br><button data-balloon-pos="up" data-balloon-length="large" data-balloon="Costa, Joseph Louis | Born: 1897. Died: 1969.
Lieutenant, French Foreign Legion.">Joe</button><br>Pian<br><p class="centered">Mr. E.R. Silvers<br>Rahway<br>N.J.<br></p><span class="pre-printed">Publié au bénéfice des Asiles des Soldats Invalides Belges <br> Siège social provisoire : 79 Mark Lane (Londres) <br> Imprimé par GEO. W. JONES, à l'Enseigne du Dauphin. 12-14 Gough Sq., Londres.</span>
</section>
* * * 
...
<section class="letter" data-tags="all censorship loneliness routine"><p class="centered large"> AMERICAN Y.M.C.A. <br> ON ACTIVE SERVICE <br> WITH THE <br> AMERICAN EXPEDITIONARY FORCES </p>
...
<section class="letter" data-tags="all officers football marriage"><p class="centered large"> AMERICAN YMCA <br> ON ACTIVE SERVICE <br> WITH THE <br> AMERICAN EXPEDITIONARY FORCES </p>
...
<section class="letter" data-tags="all correspondence marriage loneliness families">
...
EGB.<p class="centered small add">Censored. <i>JE Dunlap [?]</i><br>1st Lieut <br><i>MOMC [?]</i></p>
</section>
* * * 
...
EGB.<p class="centered small add">OK.<br><i>Lt. L.S. Vacey [?]</i></p>
</section>
* * * 
...
<section class="letter" data-tags="all marriage money"><p class="centered large"> AMERICAN YMCA <br> ON ACTIVE SERVICE <br> WITH THE <br> AMERICAN EXPEDITIONARY FORCE </p>
...
<section class="letter" data-tags="all loneliness correspondence marriage routine"><p class="centered large"> AMERICAN YMCA <br> ON ACTIVE SERVICE <br> WITH THE <br> AMERICAN EXPEDITIONARY FORCE </p><p class="centered small add">Bracher</p>
...
EGB.<p class="centered small add"><i>Capt M.C. Peary [?]</i><br> U.S. Army</p>
</section>
* * * 
...
<section class="letter" data-tags="all correspondence military-hospitals masculinity marriage families football"><p class="centered small">P.S. Sil, this letter isn't written for publication so for Pete's sake dont think that this is. EGB</p>
...
<section class="letter" data-tags="all military-hospitals masculinity officers">
...
<section class="letter" data-tags="all greek-life flu marriage military-operations">
...
<section class="letter" data-tags="all officers">
...
<section class="letter" data-tags="all correspondence football flu casualties diseases"><p class="right">Convalescent Camp,<br>Hospital Center,Savenay.<br></p>
...
<section class="letter" data-tags="all flu casualties"><p class="right">Convalescent Camp,<br>Hospital Center, Savenay.<br></p>
...
<section class="letter" data-tags="all correspondence routine diseases"><p class="centered small add">Bracher<br></p><p class="right">Convalescent Camp,<br>Hospital Center, Savenay.<br></p>
...
<section class="letter" data-tags="all correspondence families collectibles diseases routine">
