...
toc: 
 ...
 - Elizabeth J. Lindsley to Earl Reed Silvers, nd
...
Mss: <a href="https://doi.org/doi:10.7282/T3MC92RK" target="_blank"><img src="../../assets/photo-icon.png" alt="Manuscript pages" style="display:inline-block; margin-bottom:-3px;"> https://doi.org/doi:10.7282/T3MC92RK</a><br>

![Conklin's Central New Jersey Home News obituary](../../assets/figs/conklinsl.png "Conklin's obituaries from the Central New Jersey Home News and the Daily Home News together with a 1917 yearbook photo of the varsity swim team")

### Biographical note

Sherman Lindsley Conklin (RC 1916) was born January 26, 1894 in Fairfield, New Jersey, to Reverend John Woodruff Conklin (1851-1909) and Elizabeth Jane Lindsley (1852-1937). He was the youngest of four siblings; brothers Robert and Archie were also in service. Known as "Cub" by his friends, Conklin engaged in a long list of social and sporting activities while at Rutgers: football, swimming, Glee Club, editor at the _Targum_, member of the Junior Prom Committee, the Interscholastic Debating Committee, the Delta Upsilon fraternity, and so on.

At over six feet tall, Conklin's physical size undoubtedly helped in his role as ambulance driver for the American Field Service. Break-downs and blown-out tires were frequent, for the roads were in ruins from the constant artillery fire and rain. All of the American ambulance sections were on duty with the French Army. Consequently, many in the Ambulance Corps came to adopt French terminology in their writing, speaking of *blessés* for wounded and *ambulanciers* for drivers. The unforgiving task of evacuating the injured from the Front meant the Ambulance Corps experienced a casualty rate second only to infantry.

Conklin was known as the poet and scribe of his section, Section Sanitaire (États-)Unis (SSU) 635, writing frequently for the _American Field Service Bulletin_. His comrade J. B. Calvo described him as indefatigable, kind, generous, and utterly devoted to duty. Conklin clearly saw the fate that would await him, composing many poems of both a serious and humorous nature, like "A Military Graveyard" and "The Song of Dead Ambulance Men."

After a retreat from the Chemin des Dames that began on May 27, 1918, Conklin's ambulance section went back over disputed territory with a French dismounted calvary division. While the section was in Montgobert on June 12, Conklin's friend and comrade John ("Nip") Nazel was shot through the leg by machine gun fire, and shortly thereafter, Conklin himself was hit in the head (or neck---accounts differ) by a shell fragment, dying instantly. Nip was the very same friend whom Conklin had saved a few months prior from a gasoline fire by smothering him with his own body, and for which Conklin was awarded the *Croix de Guerre*. While both Conklin and Nazel recovered from their burns in that incident, Conklin would not return from the attack in Montgobert. A distinguishing element of Conklin's file is a letter of condolence to his mother, signed by every member of SSU 635, including many who were still recuperating in the hospital. His remains are in the Aisne-Marne American Cemetery.

Conklin's parents were missionaries for the Reformed Church and had spent seven years in India. His older sister, Elisabeth Woodruff Conklin, was born in 1885 in Madras, India. Devotion to duty (or a desire to keep occupied) clearly ran in the family, as Conklin's mother moves about constantly through her correspondence with Silvers about the obituary to appear in the _Rutgers Alumni Quarterly_. In the fall of 1918, she invites Silvers to write to her at the International Institute of San Antonio, Texas, where presumably she was assisting the YWCA with women and girls of different ethnicities and cultural backgrounds.

*Say, give us the ghost of an ambulance and let us drive away / Somewhere, where there's an angel-fight, and there, by the Lord, we'll stay.*

[S. L. Conklin, 1918](https://hdl.handle.net/2027/wu.89100091297?urlappend=%3Bseq=353%3Bownerid=13510798893813291-387)
...
<li>Lévêque, Guillaume. 2009. <a href="https://clio-cr.clionautes.org/le-service-de-sante-aux-armees-pendant-la-premiere-guerre-mondiale.html">“Le Service de santé aux armées pendant la Première Guerre mondiale.”</a> La Cliothèque. January 4, 2009.</li>

<li>"Rutgers Graduate Who Saved Life of Friend in France and Won Coveted Croix de Guerre for Bravery Under Fire is Resting Comfortably in Hospital," <i>The Central New Jersey Home News</i> (New Brunswick, New Jersey), March 3, 1918, p. 13.</li>

<li>"Rutgers Man Falls While in Action," <i>The Central New Jersey Home News</i> (New Brunswick, New Jersey), July 11, 1918, p. 1.</li>

<li>Seymour, James William Davenport, ed. 1920. <a href="https://catalog.hathitrust.org/Record/005893912"><i>History of the American Field Service in France</i></a>. Vol. 3. Boston, MA: Houghton Mifflin Company.</li>
</ol>

### Subject tags

<div id="subject-filters">
<button class="btn active" role="btn" onclick="filterLetters('all')">All</button>
<button class="btn" role="btn" onclick="filterLetters('bereavement')">Bereavement</button>
<button class="btn" role="btn" onclick="filterLetters('casualties')">Military casualties</button>
<button class="btn" role="btn" onclick="filterLetters('courage')">Courage</button>
<button class="btn" role="btn" onclick="filterLetters('greek-life')">Greek letter societies</button>
<button class="btn" role="btn" onclick="filterLetters('medals')">Croix de guerre (France)</button>
<button class="btn" role="btn" onclick="filterLetters('military-service')">Draft</button>
<button class="btn" role="btn" onclick="filterLetters('missionaries')">Missionaries</button>
<button class="btn" role="btn" onclick="filterLetters('obituaries')">Obituaries</button>
<button class="btn" role="btn" onclick="filterLetters('poems')">Poetry</button>
<button class="btn" role="btn" onclick="filterLetters('portrait')">Portrait photography</button>
<button class="btn" role="btn" onclick="filterLetters('religion')">Religion</button>
<button class="btn" role="btn" onclick="filterLetters('translation')">Translating and interpreting</button></div>

## Elizabeth J. Lindsley to Earl Reed Silvers, November 25, 1917

<section class="letter" data-tags="all military-service">
<p class="pre-printed centered"> NEWARK N.J. <br> NOV25 1917 <br> 10—PM </p>
<p class="pre-printed centered">THIS SIDE OF CARD IS FOR ADDRESS</p>
<p class="left"><button data-balloon-pos="up" data-balloon-length="large" data-balloon="Silvers, Earl Reed | Born: 1891. Died: 1948. Director, War Service Bureau.">Earl Reed Silvers</button><br>Rutgers College<br>New Brunswick N. J.<br></p>
...
<p class="indent-8"> (Mrs) <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Lindsley, Elizabeth Jane | Born: 1852. Died: 1937.
Mother to Sherman Conklin.">Elizabeth J. Conklin</button></p>
<p class="indent-8"><button data-balloon-pos="up" data-balloon-length="large" data-balloon="247 Belleville Ave"><a href='https://geohack.toolforge.org/geohack.php?params=40_45_33_N_74_10_8_W'>247 Belleville Ave</a></button>, Newark<br></p>
</section>
* * *

## Various to Elizabeth J. Lindsley, June 17, 1918

<section class="letter" data-tags="all bereavement"><p class="centered small add"> Copy </p><p class="left">S.S.U.NO. 635<br><button data-balloon-pos="up" data-balloon-length="large" data-balloon="Montgobert, France"><a href='https://tools.wmflabs.org/geohack/geohack.php?params=49_18_28_N_3_8_57_E'>With the French Army.</a></button><br></p>
...
<br>
<p class="indent-1"> Ethelbert D. Warfield, Jr. R.B.Johnson, James W.D.Seymour, <br> William A.Edwards, Albert L.Gandy, James F.Hunter, Berbard A. Bridget <br> Chas.M.Peck, John K. Tellien, Hugh Ward Lutz, <br> James Palmer, William W. McCarthy Carleton Day Wright, <br> John V.Ward,Jr., Edmund J. Coolidge, John C. Farmer, Samuel Bernstein, <br> Chester McArthur, C. Hayne Walton, Charles S. Richardson, <br> Guy C.Bishop, Walter G. Garritt, William H.Richards,<br> Gouverneur Smyth, Edwin W. Gheer, Charles H. Christian, J. DeWitt Toll, Jr., <br> W.B. Wood, Lewis W. Mustard,Jr., William P. Church, James F. Hunter, J.P Fletcher <p class="centered small add"> (over) </p></p>

<p class="indent-1">Howard W.Vander Voorth, J.P. Fletcher, <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Calvo, Joaquin Bernardo | Born: 1893. Died: 1952.
Private, Abulance Service.">Joaquin B. Calvo</button>.<br> 1st Lieut. B. K Niftel. <br> John M. Nazel,(in hospital), <br> Sidney M.Eddy, " " <br> Herbert Harvey, " " <br> Robert Ogden, (in Officers' School). <br></p>
<p class="centered small add"> Do not return </p>
</section>
* * * 

## Elizabeth J. Lindsley to Earl Reed Silvers, n.d.

<section class="letter" data-tags="all courage medals casualties"><p class="centered large"><p class="centered">Woman's Board of Foreign Missions,<br>REFORMED CHURCH IN AMERICA.<br>Editor of THE MISSION GLEANER,<br>Mrs. John W. Conklin,<br>247 Belleville Ave., Newark, N.J.<br></p></p>
<p class="left"><del>My dear Annie —</del></p>
<del>For <i>Aberdeen [?]</i> Maryland He <br> has a Captain’s Commission! </del><i>Lovingly [?]</i><br> EJC <del>Thank you so much — It is <u>beautiful</u>. I <i>donot</i> [sic] see how any other color could be any prettier, and I shall use it daily.</del>
Our latest excitement is the news from Sherman — He was near a comrade whose coat was on fire — (saturated with <i>gasolene</i> [sic]) and Sherman caught him and tried to beat the fire with his hands. They tell me he succeeded in saving the man’s life, but was badly burned — They were both taken to the Hospital & have the best of care — but of course Sherman cannot write with bandaged  hands — The new treatment spraying with wax seems almost miraculous in its effects. Both boys are getting well — the other one was more seriously burned on chest Sherman will have one scar on cheek and one between eyebrows — The officer who wrote home said: “We are everlastingly proud of him” The French general has given him a Croix de Guerre with a silver star which means “divisional citation” Yesterdays letter said the other man had taken a turn for the better — The dressing <sup>of the burns</sup> has been very painful — but I am so grateful that eyes are saved.
<del> Herbert Burlings engagement is announced to Mayone Kelly of Chatham — Jay <i>started [?]</i> today </del>
</section>
* * * 

## J. B. Pelletier to Elizabeth J. Lindsley, August 5, 1918

<section class="letter" data-tags="all religion bereavement casualties">
<p class="right">August 5, 1918.</p>

<p class="left">Madam,</p>

It is a Catholic Chaplain attached to the <button data-balloon-pos="up" data-balloon-length="large" data-balloon="The prestige of the French cuirassiers, a unit of cavalry known for their elaborate uniforms, dated from the Napoleonic Wars. They were last fielded in World War I. | From: Wikipedia"> <a href="https://en.wikipedia.org/wiki/French_Army_in_World_War_I">8th infantry cuirassiers</a> </button> who addresses these lines to you. Kindly pardon me; but I thought you might be happy to know that he who writes you this was with your son when the shell exploded.

 I liked <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Conklin, Sherman L. | Born: 1894. Died: 1918.
Private, Ambulence Service."><i>Herman</i> [sic]</button> very much, so serious a nature and so artistic a soul. We were rapidly becoming friends in spite of the fact that our acquaintance was so recent. Your son, Madam was very <i>conjenial</i> [sic] to me.

 We happened upon one another before <button data-balloon-pos="up" data-balloon-length="large" data-balloon="This letter was translated from the original French, which was not kept by Silvers. A few errors may have been introduced, such as this reference to 'Donusnerton' which does not appear to exist. It is difficult to say what might have been intended.">Donusnerton in the Somme</button>, in the forest not far from <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Montgobert, France"><a href='https://tools.wmflabs.org/geohack/geohack.php?params=49_18_22_N_3_8_56_E'>Montgobert</a></button>. We were chatting peacefully in spite of the shells that were exploding around us. Alas! It was to be our last conversation. A shell fell in our midst and several men were struck, among them your dear son. After the first shock, I went to him, made the sign of the cross upon his forehead as a last benediction and repeated a prayer in the name of his mother. Your son, Madam, was as though he slept. 

Some of the men unfortunately were wounded: <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Sidney Eddy and John (Nip) Nazel were the names of the wounded. They are among the signatories of the letter to Mrs. Conklin from the SSU 635.">two of our surgeons</button>. After having carried these off with the assistance of <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Bernard Alexander Bridget, another signatory of the SSU 635 letter.">Bridget</button>, a friend of <i>Herman's</i> [sic], I returned I did my utmost to bring the body of our poor comrade to his American friends who buried him at <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Mortefontaine, France"><a href='https://tools.wmflabs.org/geohack/geohack.php?params=49_19_53_N_3_4_31_E'>Mortefontain</a></button>.

These particulars, Madam, may be of  interest to you.
...
<br>
<p class="indent-1"><p class="centered small add">(Signed)</p></p>

<p class="indent-5"><button data-balloon-pos="up" data-balloon-length="large" data-balloon="Pelletier, J. B. | Born: 19--. Died: 18--.
...
<section class="letter" data-tags="all bereavement casualties">
...
<p class="indent-2"><button data-balloon-pos="up" data-balloon-length="large" data-balloon="Sherman's sister, Elizabeth Woodruff Conklin, was the likely typist of this transcribed letter."><p class="centered small add"> (Signed) </p></button><button data-balloon-pos="up" data-balloon-length="large" data-balloon="Peck, Charles Howard | Born: 1870. Died: 1927.
...
<section class="letter" data-tags="all translation bereavement portrait">
<p class="right"><button data-balloon-pos="up" data-balloon-length="large" data-balloon="247 Belleville Ave"><a href='https://geohack.toolforge.org/geohack.php?params=40_45_33_N_74_10_8_W'>247 Belleville Ave.,</a></button><br>Newark, N.J.<br></p>
...
The original of the above came to Mother in this morning’s mail, and I am hurrying it at once to you, if you can and care to, include it with the letters Mother has already sent. I am also enclosing the original of a letter from the priest to whom Sherman was speaking at the time. As I am unfamiliar with  French, I dare not copy it. Of course you realize how very precious this letter is to us, and I know you will not let it go out of your hands, and will return it at once to us, please. And may I ask that you have it translated very accurately please, for in the article the "Home News", — <i>"blessè"</i> [sic] was <button data-balloon-pos="up" data-balloon-length="large" data-balloon='The Daily Home News Article reproduces a translation of General Lejaille of the French 97th infantry division, which does indeed state that Sherman was "[g]reatly blessed" when rescuing his comrade Nip Nazel from a gasoline fire.'>carelessly translated</button> to <del>from</del><u>"blessed"</u>!!
...
Sister to Sherman L. Conklin.">Elisabeth W. Conklin</button></p>
P.S.
If you cannot use the enclosed <i>snap [?]</i> shot taken the day before, please return it at once to us, in the enclosed envelope.
...
<section class="letter" data-tags="all portrait casualties bereavement obituaries">
...
<section class="letter" data-tags="all portrait poems casualties obituaries bereavement greek-life">
...
I am very sorry for this delay, but I have not been home and your letter has just reached me — I will send at once this evening or tomorrow morning, a photograph of Sherman — with copies of letters from the section  and from him. I cannot <p class="centered small add"> [2] </p> get them together just now in time for this mail — but will send them within twenty four hours. I know your time is limited if you need copy for the October number. I have sent to the <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Delta Upsilon Quarterly">D.U. Quarterly</button> for a copy of the June issue containing <p class="centered small add"> [3] </p>six poems by Sherman. It is to come to you direct.

I cannot think of Sherman as gone. He has <u>not</u> gone for I know he is very near me all the time.

<p class="indent-1">Yours very sincerely</p>
<br>
...
<section class="letter" data-tags="all translation">
...
Owing to the unusual pressure of business accompanying the opening of college I have been unable to have the enclosed letter translated until now. I am, however, sending you a translation which was made by <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Hauch, Edward Franklin | Born: 1879. Died: 1953.
Assistant Professor of German.">Professor Hauch</button> of our faculty. Thank you very much for your kindness in sending it to us.
...
<section class="letter" data-tags="all portrait missionaries">
...
<section class="letter" data-tags="all portrait">
...
<section class="letter" data-tags="all obituaries poems">
...
I am rather at a loss as to how to answer definetely your question about securing copies of the <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Founded in 1869, The Targum is the second oldest college newspaper in the United States. Since its founding, the newspaper has been published continuously with the exception of 19 months during the second world war. | From: The targum
                            (1869:Nov.)"> <a href="https://doi.org/doi:10.7282/t3-gqks-4z62">Targum</a> </button>. If you will give me <i>allittle</i> [sic] time I shall try to find out the best way in which we may gather together all of Sherman's writings. I shall try very hard to find some way which will not necessitate <i>yur</i> [sic] coming to New Brunswick and doing the work yourself and shall write you just as soon as I can conveniently arrange things.

Under separate cover is going six copies of the Quarterly to <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Hovey was Conklin's fiancée. | From: Engagement Announced, The Courrier-News (Bridgewater, NJ), May 4, 1917."> <a href="https://www.newspapers.com/image/220737822">Miss Ellen C. Hovey</a> </button>.

<p class="indent-2">Very sincerely yours,</p>
<br>
<p class="indent-2"><button data-balloon-pos="up" data-balloon-length="large" data-balloon="Silvers, Earl Reed | Born: 1891. Died: 1948.
Director, War Service Bureau."></button></p>
...
<section class="letter" data-tags="all obituaries bereavement"><p class="right">135 East French Place<br>San Antonio<br>Texas<br></p>
<p class="right">January 24, 1919</p>

<p class="left">My dear Mr. <button data-balloon-pos="up" data-balloon-length="large" data-balloon="Silvers, Earl Reed | Born: 1891. Died: 1948.
Director, War Service Bureau.">Silvers</button>—</p>

It was very kind to let us have all of those copies of the Quarterly, and I cannot half thank you — I feel as if I should not ask for any more copies without paying for them — There are so  many of Sherman's friends, who would not see the Quarterly to whom I want to send copies — I am thinking of the men in his Ambulance Section in France, and of others.

Would it be possible for us to have more copies? I will be so glad to pay for them  with kind regards & thanks for your great kindness, and memories of hearing of happy hours Sherman spent with <i>you [?]</i>
...
<script src="../../assets/maps/conklinsl_scripts.js"></script>
